...
def optimize_with_default_simulation_settings(
    ...
    return network.optimize(
        ...
        solver_options={"random_seed": RANDOM_SEED} if solver_name == "highs" else None,
...
def solve_base_stochastic_dispatch_scenario(
    ...
    result = optimize_with_default_simulation_settings(
        ...
        extra_functionality=add_stochastic_dispatch_constraints,
    )
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build the PyPSA topology encoded from Network.png."
    )
    parser.add_argument(
        "--export-netcdf",
        default=None,
